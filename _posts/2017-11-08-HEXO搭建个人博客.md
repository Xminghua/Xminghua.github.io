...
　　搭建个人博客已经有半年之久，却一直没有将自己的整个心酸历程表达出来，在当初自己搭建hexo个人博客的时候，也是经过各种找资料，踩过各种坑，终于使用 hexo 搭建个人博客初步完成了，我的域名是[www.xminghua.cn](www.xminghua.cn)，以下是我从最初作为一名盲者，到最终搭建好自己的个人博客，这个过程中的全部总结和体会。     

　　本篇文章算是我的第一篇比较正式的技术性博客，之前都一直没有时间来整理自己的方法和技术，读者有什么问题可以给我在评论里给我留言，问题很着急的可以加我 ＱＱ：404125822　，或者给我发邮件：[404125822@qq.com](404125822@qq.com)  ，都可以，如果你已经搭建完成了，可以继续进行提高操作，如何能百度搜索你的博客、多台电脑使用HEXO发布博客等。我现在的博客是使用 Jekyll 搭建的[http://www.xminghua.cn](www.xminghua.cn)，相比以前的hexo博客有更多的交互性质，我可以随意在多多台电脑上进行博客的编写，体验感也很强。 
...
翻到最下面，改成我这样子的，注意： `: 后面要有空格`
	...
	deploy:
	  type: git
	  repository: https://github.com/Xminghua/Xminghua.github.io.git
	  branch: master
...
　然后再浏览器中输入[http://www.xminghua.cn/](http://www.xminghua.cn/)就行了，我有域名叫做：[www.xminghua.cn](http://www.xminghua.cn)，如果没有自己的域名的话，用github账户名[http://Xminghua.github.io](http://Xminghua.github.io)也可以，我的 github 的账户叫 Xminghua,把这个改成你 github 的账户名就行了
...
转载请注明原地址，Xminghua的博客：[http://www.xminghua.cn](http://www.xminghua.cn) 谢谢！
